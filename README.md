...
design: https://bytedance.feishu.cn/docx/CyVTd1jrIoBnsvxqJMBcSfcWntg
...
- Client: example/helloword/greeter_client/main.go
- Server: example/helloword/greeter_server/main.go

#### Integrate with application

- example/best_practice/idl/example.go shown that using stream's buffer interface to do serialization and deserialization.
- example/best_practice/shmipc_client.go provides a client demo which using synchronous interface.
- example/best_practice/shmipc_server.go provides a server demo which using synchronous interface.
- example/best_practice/shmipc_async_client.go provides a server demo which using asynchronous interface.
- example/best_practice/shmipc_async_server.go provides a server demo which using asynchronous interface.
